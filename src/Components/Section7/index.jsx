...
const Section7 = () => {
    return(
        <div className="section7"> 
            ...
            <p>
                Apple Vision Pro will be available early next year on <Link to="/">apple.com</Link> and at Apple retail stores in the U.S.
            </p>
            <p>
            ...
            <p>
                Learn more about how Apple Card applications are evaluated at <Link to="/">support.apple.com/kb/HT209218</Link>.
            </p>
            <p>
